...
transformer_configs = {
    ...
    "medium": dict(block_size=512, n_layer=4, n_head=8, n_local_heads=2, dim=2048, intermediate_size=7168, rope_base=1000000.0, num_experts=8, num_activated_experts=2),
