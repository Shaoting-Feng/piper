...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="test/schedules/llama_pp_only.json",
...
if __name__ == "__main__":
    ...
    pg = create_piper_placement_group(args.schedule_directives_file, pp_outer=args.pp_outer)
